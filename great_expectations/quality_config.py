...
EXPECTED_COLUMNS = {
    "bronze_weather": [
        "latitude", "longitude", "daily", "source", "file_type", "ingestion_time"
    ],
    "bronze_mobility": [
        "date", "sub_region_1", "workplaces_percent_change_from_baseline",
        "transit_stations_percent_change_from_baseline", "parks_percent_change_from_baseline",
        "source", "file_type", "ingestion_time"
    ],
    "silver_weather": [
        "date", "temperature_max", "temperature_min", "precipitation_sum",
        "snowfall_sum", "wind_speed_max", "latitude", "longitude", "ingestion_time"
    ],
    "silver_mobility": [
        "date", "sub_region_1", "workplaces_percent_change_from_baseline",
        "transit_stations_percent_change_from_baseline", "parks_percent_change_from_baseline",
        "residential_percent_change_from_baseline", "source", "ingestion_time"
    ]
}
