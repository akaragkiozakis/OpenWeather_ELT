...
def create_sample_weather_data():
    ...
    sample_data = {
        ...
        "daily": [
            ...
            {
                "time": ["2020-02-15", "2020-02-16"],
                "temperature_2m_max": [14.8, 15.5],
                "temperature_2m_min": [7.2, 8.0],
            },
        ],
...
def test_bronze_weather_expectations(df):
    ...
    log_message("🌤 Testing Bronze Weather Data Expectations...")
...
def test_bronze_mobility_expectations(df):
    ...
    log_message("🚗 Testing Bronze Mobility Data Expectations...")
    ...
    # Test 1: Table should exist (row count > 0)
    result1 = ge_df.expect_table_row_count_to_be_between(
    ...
    result5 = ge_df.expect_column_values_to_be_between(
        column="workplaces_percent_change_from_baseline", min_value=-100, max_value=500
    )
...
def main():
    ...
    if weather_passed and mobility_passed:
        log_message("✅ ALL TESTS PASSED! Data quality checks successful.")
        return True
    else:
        log_message("❌ SOME TESTS FAILED! Please review data quality issues.")
        return False
