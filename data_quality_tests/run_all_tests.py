...
def run_all_tests():
    ...
    test_scripts = [
        "test_bronze_local.py",
        "test_silver_local.py"
    ]
    ...
    log_message(f"📊 Overall Success Rate: {total_passed}/{total_tests} ({success_rate:.1f}%)")
    ...
    if total_passed == total_tests:
        ...
        log_message("⚠️  Some tests failed. Please review and fix issues before proceeding.")
        return False
